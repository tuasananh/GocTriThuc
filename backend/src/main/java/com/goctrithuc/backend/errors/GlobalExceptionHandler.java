...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
  ...
  public ResponseEntity<Object> handleAccessDenied(HttpServletRequest request) {
    return ResponseEntity.status(403).body(body(403, "Access denied", request.getRequestURI()));
  }
  ...
  public ResponseEntity<Object> handleUnexpected(RuntimeException ex, HttpServletRequest request) {
  ...
  protected ResponseEntity<Object> handleExceptionInternal(
    ...
    String path =
        (request instanceof ServletWebRequest swr) ? swr.getRequest().getRequestURI() : "";
    Map<String, Object> b =
        body(status.value(), ex.getMessage() != null ? ex.getMessage() : "Request error", path);
