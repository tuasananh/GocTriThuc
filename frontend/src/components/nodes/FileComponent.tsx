...
export default function FileComponent({
    ...
    return (
        <div
            ref={componentRef}
            className={`inline-block my-2 mx-1 p-3 rounded-lg border transition-all duration-200 cursor-default select-none ${isSelected
        ...
        >
            <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col min-w-[120px]">
                    <span className="text-sm font-semibold text-zinc-900 dark:text-zinc-100 truncate max-w-[200px]" title={fileName}>
                        {fileName}
                    </span>
                    {fileSize && (
