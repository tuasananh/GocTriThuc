...
import { $getSelection, $addUpdateTag, LexicalEditor, SKIP_SELECTION_FOCUS_TAG } from 'lexical';
...
export function FontDropDown({ editor, value, disabled = false }: FontDropDownProps) {
