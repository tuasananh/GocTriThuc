...
export const MathBlock = createReactBlockSpec(
  ...
  } as const,
  {
    render: (props) => {
      ...
      return (
        <div className="w-full flex justify-center py-4 my-2 rounded-md ring-offset-background focus-within:ring-2 focus-within:ring-ring focus-within:ring-offset-2 transition-all" data-math-block="true">
          {createElement(
            "math-field",
            {
              ref,
              ...
              style: { width: '100%', minHeight: '3em', padding: '0.5em', fontSize: '1.2em', color: 'inherit', background: 'transparent', outline: 'none', border: 'none' }
            },
            latex
          )}
        </div>
    ...
    toExternalHTML: (props) => {
      return createElement(
        "div",
        { className: "math-block-wrapper", style: { display: "flex", justifyContent: "center", padding: "1rem 0" } },
        createElement(
          "math-field",
          {
            "read-only": true,
