...
function DropDownItems({
  ...
  useEffect(() => {
    const updatePosition = () => {
      ...
      if (button !== null && dropDown !== null) {
        ...
        dropDown.style.left = `${Math.min(left, window.innerWidth - dropDown.offsetWidth - 20) / zoom}px`;
      }
    };
  ...
  return (
    <DropDownContext.Provider value={contextValue}>
      <div className="dropdown-items" ref={dropDownRef} onKeyDown={handleKeyDown}>
        {children}
      </div>
